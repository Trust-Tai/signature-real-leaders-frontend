...
export default function ProfileReadyModal({ isOpen, onClose, profileData, user, onChangeTemplate }: ProfileReadyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/90 backdrop-blur-sm">
          ...
          {[...Array(50)].map((_, i) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundColor: ['#CF3232', '#FFF9F9', '#333333', '#b82828', '#e8e8e8', '#666666'][Math.floor(Math.random() * 6)]
                }}
              />
            </div>
          ))}
      ...
      <div className="relative bg-[#FFF9F9] w-full h-full overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="fixed top-6 right-6 z-[10001] p-3 rounded-full bg-white/90 hover:bg-white shadow-lg transition-all hover:scale-110 border border-[#CF3232]"
        >
          <X className="w-7 h-7 text-[#CF3232]" />
        </button>

        {/* Header Section */}
        <div className="bg-[#FFF9F9] text-[#333333] py-12 text-center relative overflow-hidden border-b-4 border-[#CF3232]">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-10 left-10 w-20 h-20 bg-[#CF3232] rounded-full animate-pulse" />
            <div className="absolute bottom-10 right-10 w-32 h-32 bg-[#CF3232] rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
          </div>
          
          <div className="relative z-10">
            <div className="flex justify-center mb-6">
              <Sparkles className="w-20 h-20 animate-bounce text-[#CF3232]" />
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-4 animate-fade-in font-abolition text-[#333333]">
              🎉 Congratulations! 🎉
            </h1>
            <p className="text-2xl md:text-3xl font-semibold font-outfit text-[#333333]">
              Your Public Profile is Ready!
            </p>
            <p className="text-lg md:text-xl mt-4 opacity-90 font-outfit text-[#333333]">
        ...
        <div className="relative">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-[#FFF9F9] border-t-4 border-[#CF3232] shadow-2xl z-[10001] p-6">
            <div className="max-w-6xl mx-auto">
              <div className="flex flex-col  items-center gap-4">
                {/* Share Link Section */}
                <div className="flex-1 w-full">
                  <p className="text-sm text-[#333333] mb-2 font-semibold font-outfit">
                    🎉 Share your profile:
                  </p>
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-white text-[#333333] border-2 border-gray-300 rounded-lg text-sm font-mono font-outfit"
                    />
                    <button
                      onClick={() => {
                      ...
                      className="px-6 py-3 bg-[#CF3232] text-white rounded-lg hover:bg-[#b82828] transition-colors text-sm font-bold whitespace-nowrap font-outfit"
                    >
                      Copy Link
                    </button>
                  </div>
                ...
                <div className="flex gap-3 w-full lg:w-auto">
                  <button
                    ...
                    className="flex-1 lg:flex-none px-6 py-3 bg-white text-[#CF3232] font-bold rounded-lg border-2 border-[#CF3232] hover:bg-[#FFF9F9] transition-all shadow-md hover:shadow-lg whitespace-nowrap font-outfit"
                  >
                    Change Template
                  </button>
                  <button
                    onClick={handleGoToDashboard}
                    className="flex-1 lg:flex-none px-8 py-3 bg-[#CF3232] text-white font-bold rounded-lg hover:bg-[#b82828] transition-all shadow-lg hover:shadow-xl whitespace-nowrap font-outfit"
                  >
                    Go to Dashboard
                  </button>
                </div>
