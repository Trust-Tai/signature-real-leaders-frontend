...
import { Search, ChevronLeft, ChevronRight, X, Plus, Download, Filter, Loader2, Settings, Link, Trash2, Target } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="relative w-full sm:w-auto">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm w-full sm:w-64 font-outfit"
            style={{ color: '#949494' }}
          />
        </div>
      </div>
