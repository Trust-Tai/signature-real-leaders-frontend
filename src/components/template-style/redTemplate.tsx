      ...
      <div className="w-full max-w-md">
        ...
        {profileData.rss_feed_url && (
          <a
            ...
            className="block bg-gradient-to-r from-orange-500/30 to-orange-600/30 backdrop-blur-sm rounded-xl p-4 mb-4 border border-orange-400/40 hover:from-orange-500/40 hover:to-orange-600/40 transition-all group"
          >
        ...
        {/* Newsletter Text - Show only if newsletter_service is configured and user is viewing someone else's profile */}
          ...
          <div className="flex items-start justify-center space-x-3 mb-4 px-2">
            {newsletterLoading ? (
              ...
              <input
                ...
                className="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded mt-1 focus:ring-red-500 flex-shrink-0 cursor-pointer"
              />
            )}
